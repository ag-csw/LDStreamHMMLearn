...
class Approach_Test(TestCase):
    ...
    def test_taumeta_num_traj(self):
        ...
        plot_result_heatmap(avg_times_naive, avg_times_bayes, taumeta_values, timescale_disp_values, "Performance", "Heatmap Performance Taumeta Timescaledisp")
        plot_result_heatmap(avg_errs_naive, avg_errs_bayes, taumeta_values, timescale_disp_values, "Error", "Heatmap Error Taumeta Timescaledisp")
