...
class Approach_Test(TestCase):
    ...
    def test_taumeta_scale_win(self):
        ...
        plot_result_heatmap(avg_times_naive, avg_times_bayes, taumeta_values, scale_win_values, "scale_win", "Performance", "Heatmap Performance Taumeta ScaleWin")
        plot_result_heatmap(avg_errs_naive, avg_errs_bayes, taumeta_values, scale_win_values, "scale_win", "Error", "Heatmap Error Taumeta ScaleWin")
