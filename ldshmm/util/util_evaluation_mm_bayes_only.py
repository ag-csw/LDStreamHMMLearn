    ...
    def test_statconc_eta(self):
        ...
        for one, statconc in enumerate(statconc_values):
            for two, eta in enumerate(eta_values):
                ...
                log_total_time_naive, log_avg_err_naive, log_total_time_bayes, log_avg_err_bayes = self.helper_statconc(Variable_Holder.len_trajectory_max, self.num_trajectories)
